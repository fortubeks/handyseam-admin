...
<body class="g-sidenav-show  bg-gray-100">
    ...
    @include('material.layouts.auth.sidenav')
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        @include('material.layouts.auth.topnav')

        @yield('content')
        @include('material.layouts.auth.footer')
        <!-- </div> -->
    </main>
    <div class="fixed-plugin">
        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body pt-sm-3 pt-0">
                ...
                <a class="btn btn-outline-dark w-100" target="_blank" href="https://www.creative-tim.com/learning-lab/bootstrap/overview/material-dashboard">View documentation</a>
